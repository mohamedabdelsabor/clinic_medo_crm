...
<?php $__env->startSection('title','تعديل بيانات المريض'); ?>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6 relative z-10">
            ...
            <div class="relative">
                <select name="gender"
                    ...
                    <option value="male" <?php echo e(old('gender',$patient->gender)=='male'?'selected':''); ?>>ذكر</option>
                    <option value="female" <?php echo e(old('gender',$patient->gender)=='female'?'selected':''); ?>>أنثى</option>
                </select>
                <label class="absolute right-4 top-2 text-xs text-slate-300 peer-focus:text-sky-400 transition">
                    النوع
                </label>
            ...
            <div class="relative">
                <input type="date" name="birth_date"
                       value="<?php echo e(old('birth_date', optional($patient->birth_date)->format('Y-m-d'))); ?>"
                       class="peer w-full bg-transparent border border-white/30 dark:border-white/10 rounded-xl px-4 pt-6 pb-2 focus:outline-none focus:ring-2 focus:ring-sky-400 transition">
                <label class="absolute right-4 top-2 text-xs text-slate-300 peer-focus:text-sky-400 transition">
                    تاريخ الميلاد
                </label>
            ...
            <div class="relative md:col-span-2">
                <textarea name="notes" rows="3"
                          class="peer w-full bg-transparent border border-white/30 dark:border-white/10 rounded-xl px-4 pt-6 pb-2 focus:outline-none focus:ring-2 focus:ring-sky-400 transition"><?php echo e(old('notes',$patient->notes)); ?></textarea>
                <label class="absolute right-4 top-2 text-xs text-slate-300 peer-focus:text-sky-400 transition">
                    ملاحظات
                </label>
            </div>
...
<?php echo $__env->make('layouts.dashboard', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH E:\xampp\htdocs\clinic-crm\resources\views/patients/edit.blade.php ENDPATH**/ ?>