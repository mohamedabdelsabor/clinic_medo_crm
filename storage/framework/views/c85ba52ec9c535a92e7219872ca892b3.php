...
<div class="flex h-screen">
    ...
    <aside x-data="{ sidebar: true }"
        ...
        <nav class="space-y-2 text-sm">
            <a href="<?php echo e(route('dashboard')); ?>"
               ...
               <?php echo e(request()->routeIs('dashboard') ? 'bg-sky-200/60 dark:bg-white/15 font-semibold' : 'hover:bg-sky-200/50 dark:hover:bg-white/10'); ?>">
                📊 <span x-show="sidebar">الداشبورد</span>
            </a>

            <a href="<?php echo e(route('doctors.index')); ?>"
               class="flex items-center gap-3 p-3 rounded-xl transition
               <?php echo e(request()->routeIs('doctors.*') ? 'bg-sky-200/60 dark:bg-white/15 font-semibold' : 'hover:bg-sky-200/50 dark:hover:bg-white/10'); ?>">
                👨‍⚕️ <span x-show="sidebar">الأطباء</span>
            </a>

            <a href="<?php echo e(route('patients.index')); ?>"
               class="flex items-center gap-3 p-3 rounded-xl transition
               <?php echo e(request()->routeIs('patients.*') ? 'bg-sky-200/60 dark:bg-white/15 font-semibold' : 'hover:bg-sky-200/50 dark:hover:bg-white/10'); ?>">
                🧑‍🤝‍🧑 <span x-show="sidebar">المرضى</span>
            </a>

            <a href="<?php echo e(route('appointments.index')); ?>"
               class="flex items-center gap-3 p-3 rounded-xl transition
               <?php echo e(request()->routeIs('appointments.*') ? 'bg-sky-200/60 dark:bg-white/15 font-semibold' : 'hover:bg-sky-200/50 dark:hover:bg-white/10'); ?>">
    ...
    <main class="flex-1 p-8 overflow-y-auto scroll-smooth">
        ...
        <nav class="text-sm text-slate-500 dark:text-slate-400 mb-2 flex items-center gap-2">
            <a href="<?php echo e(route('dashboard')); ?>" class="hover:text-sky-500 transition">🏠 الرئيسية</a>
            <span>›</span>
            <span class="text-slate-700 dark:text-slate-200"><?php echo $__env->yieldContent('title','لوحة التحكم'); ?></span>
        </nav>
...
<?php /**PATH E:\xampp\htdocs\clinic-crm\resources\views/layouts/dashboard.blade.php ENDPATH**/ ?>